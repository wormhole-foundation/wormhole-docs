...
- The correct versions of the Solana CLI and Anchor installed, depending on your NTT version:
    ...
    === "v3"
        ...
        <tbody>
        <tr><td>[Solana](https://docs.solanalabs.com/cli/install){target=\_blank}</td><td>`{{ ntt.solana_cli_version }}`</td></tr>
        <tr><td>[Anchor](https://www.anchor-lang.com/docs/installation){target=\_blank}</td><td>`{{ ntt.anchor_version }}`</td></tr>
        </tbody>
        </table>
    ...
    === "v2/v1"
        ...
        <tbody>
        <tr><td>[Solana](https://docs.solanalabs.com/cli/install){target=\_blank}</td><td> `v1.18.10` </td></tr>
        <tr><td>[Anchor](https://www.anchor-lang.com/docs/installation){target=\_blank}</td><td> `v0.29.0`</td></tr>
        </tbody>
        </table>
