...
To receive a message using a Wormhole relayer, the target contract must implement the `IWormholeReceiver` interface, as shown in the [previous section](#interact-with-the-wormhole-relayer).
