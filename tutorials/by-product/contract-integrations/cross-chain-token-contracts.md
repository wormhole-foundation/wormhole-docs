...
2. Open the file. First, we'll start with the imports and the contract setup:
    ...
    --8<-- "code/tutorials/by-product/contract-integrations/cross-chain-token-transfers/snippet-1.sol:58:58"
    ```
...
4. Finally, we'll add the function that sends the tokens across chains:
    ...
    ```solidity
    --8<-- "code/tutorials/by-product/contract-integrations/cross-chain-token-transfers/snippet-1.sol:31:57"
    ```
...
2. Open the file. First, we'll start with the imports and the contract setup:
    ...
    --8<-- "code/tutorials/by-product/contract-integrations/cross-chain-token-transfers/snippet-2.sol:40:40"
    ```
...
3. Next, let's add a function inside the contract to handle receiving the payload and tokens:
    ...
    ```solidity
    --8<-- "code/tutorials/by-product/contract-integrations/cross-chain-token-transfers/snippet-2.sol:17:39"
    ```
