...
2. Install dependencies, including the [Wormhole TypeScript SDK](https://github.com/wormhole-foundation/wormhole-sdk-ts){target=\_blank}. This example uses the SDK version `4.5.0`:

    ```bash
   npm install @wormhole-foundation/sdk@4.5.0 -D tsx typescript
   ```
...
4. Install the [TypeScript SDK](/docs/tools/typescript-sdk/get-started/){target=\_blank}. This example uses the SDK version `4.5.0`:

    ```bash
    npm install @wormhole-foundation/sdk@4.5.0
    ```
...
2. Install the required dependencies. This example uses the SDK version `4.5.0`:
...
4. **Install dependencies**: Add the required packages. This tutorial uses the SDK version `4.5.0`.

    ```bash
    npm install @wormhole-foundation/sdk@4.5.0 axios web3 tsx @types/node
    ```
...
5. Open `helper.ts` and add the following code:
    ...
    You can view the list of [supported platform constants](https://github.com/wormhole-foundation/wormhole-sdk-ts/blob/4.5.0/core/base/src/constants/platforms.ts#L6){target=_blank} in the Wormhole SDK GitHub repo.
...
2. Open `attest.ts` and add the following code:
    ...
    - **Calls [`getWrappedAsset`](https://github.com/wormhole-foundation/wormhole-sdk-ts/blob/4.5.0/connect/src/wormhole.ts#L277){target=\_blank}**: Part of the `Wormhole` class, the method does the following:
        - Accepts a [`TokenId`](https://github.com/wormhole-foundation/wormhole-sdk-ts/blob/4.5.0/platforms/aptos/protocols/tokenBridge/src/types.ts#L12){target=\_blank} representing a token on the source chain.
...
- **Calls `createAttestation`**: Defined in the `TokenBridge` interface, the [`createAttestation`](https://github.com/wormhole-foundation/wormhole-sdk-ts/blob/4.5.0/core/definitions/src/protocols/tokenBridge/tokenBridge.ts#L237){target=\_blank} method does the following:
...
2. **Install dependencies**: Install the required dependencies. This tutorial uses the SDK version `4.5.0`:

    ```bash
    npm install @wormhole-foundation/sdk@4.5.0 tsx
    ```
...
2. Install dependencies, including the Wormhole TypeScript SDK. This example uses the SDK version `4.5.0`:
