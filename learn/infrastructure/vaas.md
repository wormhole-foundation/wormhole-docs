...
- `consistency_level` ++"u8"++ - the [consistency (finality) level](/docs/build/reference/consistency-levels/){target=\_blank}, required by this emitter
