...
(async function () {
  ...
  console.log("Supported destination tokens:", dstTokens.slice(0, 5));
  ...
  const transferParams = {
    amount: "0.01", // decimal string representation of the amount (e.g., 0.01 ETH)
  ...
  await routes.checkAndCompleteTransfer(
    ...
    receipt,
    receiver.signer,
    15 * 60 * 1000 // e.g., a 15-minute timeout
  );
})();