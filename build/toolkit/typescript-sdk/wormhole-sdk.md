...
```ts
--8<-- 'code/build/toolkit/typescript-sdk/get-vaa.ts::1'
```

Then, import each of the ecosystem [platforms](#platforms) that you wish to support:

```ts
--8<-- 'code/build/toolkit/typescript-sdk/get-vaa.ts:4:9'
```
...
```ts
--8<-- 'code/build/toolkit/typescript-sdk/get-vaa.ts:13:20'
```
...
```ts
--8<-- 'code/build/toolkit/typescript-sdk/get-vaa.ts:22:22'
```
...
```ts
--8<-- 'code/build/toolkit/typescript-sdk/get-vaa.ts:54:61'
```

??? code "View the complete script"
    ```ts
    --8<-- 'code/build/toolkit/typescript-sdk/get-vaa.ts'
    ```
...
```ts
--8<-- 'code/build/toolkit/typescript-sdk/config-override.ts'
```

??? code "View the complete script"
    ```ts
    --8<-- 'code/build/toolkit/typescript-sdk/config.ts'
    ```
...
```ts
--8<-- 'code/build/toolkit/typescript-sdk/get-chain.ts'
```
...
```ts
--8<-- 'code/build/toolkit/typescript-sdk/addresses.ts'
```
...
```ts
--8<-- 'code/build/toolkit/typescript-sdk/tokens.ts'
```
...
```ts
--8<-- 'code/build/toolkit/typescript-sdk/signers.ts'
```
...
```javascript
--8<-- 'code/build/toolkit/typescript-sdk/ethers.js'
```
...
???+ code "View the complete script"
    ```ts
    --8<-- 'code/build/toolkit/typescript-sdk/example-core-bridge.ts'
    ```
...
```ts
--8<-- 'code/build/toolkit/typescript-sdk/token-bridge-snippet.ts'
```
...
```ts
--8<-- 'code/build/toolkit/typescript-sdk/token-bridge.ts:120:158'
```

??? code "View the complete script"
    ```ts hl_lines="122"
    --8<-- 'code/build/toolkit/typescript-sdk/token-bridge.ts'
    ```
...
```ts
--8<-- 'code/build/toolkit/typescript-sdk/cctp.ts:69:112'
```

??? code "View the complete script"
    ```ts
    --8<-- 'code/build/toolkit/typescript-sdk/cctp.ts'
    ```
...
```ts
--8<-- 'code/build/toolkit/typescript-sdk/cctp.ts:120:126'
```
...
```ts
--8<-- 'code/build/toolkit/typescript-sdk/router.ts:24:31'
```

Once created, the resolver can be used to provide a list of input and possible output tokens.

```ts
--8<-- 'code/build/toolkit/typescript-sdk/router.ts:33:53'
```
...
```ts
--8<-- 'code/build/toolkit/typescript-sdk/router.ts:55:67'
```
...
```ts
--8<-- 'code/build/toolkit/typescript-sdk/router.ts:72:93'
```

Finally, assuming the quote looks good, the route can initiate the request with the quote and the `signer`.

```ts
--8<-- 'code/build/toolkit/typescript-sdk/router.ts:100:106'
```

??? code "View the complete script"

    ```ts
    --8<-- 'code/build/toolkit/typescript-sdk/router.ts'
    ```
...
```ts
--8<-- 'code/build/toolkit/typescript-sdk/custom-route.ts'
```
