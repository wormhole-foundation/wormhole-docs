...
The Wormhole TypeScript SDK is useful for interacting with Wormhole-connected chains and protocols built on top of Wormhole. Understanding several higher-level concepts and how the SDK abstracts them away will help you use it most effectively. The following sections will introduce and discuss the concepts of platforms, chain contexts, addresses, tokens, signers, and protocols and how the SDK helps ease development in each conceptual area.

If you prefer, you can also go directly to the [Installation](#installation) or [Usage](#usage) instructions.
