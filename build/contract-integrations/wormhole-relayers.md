...
!!! note
    To not wait for full finality you can use the [sendToEvm](https://github.com/wormhole-foundation/wormhole/blob/2ea519c09e28bb9c0417cb3a5dfba525267af5a7/sdk/js/src/relayer/relayer/send.ts#L33){target=\_blank} method to adjust the consistency level.
