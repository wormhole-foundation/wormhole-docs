...
=== "React integration"
    ...
    ```ts
    --8<-- 'code/build/transfers/connect/configuration/configure-react-v1.tsx'
    ```

=== "Hosted integration"

    ```ts
    --8<-- 'code/build/transfers/connect/configuration/configure-hosted.tsx'
    ```
...
=== "Mainnet"
    ...
    ```js
    --8<-- 'code/build/transfers/connect/configuration/custom-simple-v1.jsx'
    ```

=== "Testnet"

    ```js
    --8<-- 'code/build/transfers/connect/configuration/custom-simple-testnet-v1.jsx'
    ```
...
```typescript
--8<-- 'code/build/transfers/connect/configuration/example-cctp.ts'
```
...
```typescript
--8<-- 'code/build/transfers/connect/configuration/example-all-routes.ts'
```
...
```typescript
--8<-- 'code/build/transfers/connect/configuration/add-token.tsx'
```
...
```jsx
--8<-- 'code/build/transfers/connect/configuration/custom-tokens-whitelist.jsx'
```
...
```jsx
--8<-- 'code/build/transfers/connect/configuration/custom-disable-arbitrary-tokens.jsx'
```
...
```jsx
--8<-- 'code/build/transfers/connect/configuration/custom-tx-settings-solana.jsx'
```
...
```jsx
--8<-- 'code/build/transfers/connect/configuration/custom-coingecko-key.jsx'
```
