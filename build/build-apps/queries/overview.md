...
!!! note
	Queries are currently in closed beta, though you can start developing today! Check out [Hands on with Queries](/build/build-apps/queries/hands-on-with-queries) and reach out to [Join the beta](https://forms.clickup.com/45049775/f/1aytxf-10244/JKYWRUQ70AUI99F32Q){target=\_blank}.
...
Be sure to check out the [FAQs](/build/build-apps/queries/faqs) and the [Hands on with Queries guide](/build/build-apps/queries/hands-on-with-queries).
